...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <div class="d-flex align-items-center gap-2">
         @if($canDelete)
         <a href="{{ route('admin.payments.trash') }}" class="btn btn-sm btn-danger page-action-btn" title="Trash">
            <i class="ri-delete-bin-line"></i>
            <span>Trash</span>
        </a>
        @endif
        @if($canCreate)
        <a href="{{ route('admin.payments.create') }}" class="btn btn-sm btn-primary page-action-btn" title="Add Payment">
