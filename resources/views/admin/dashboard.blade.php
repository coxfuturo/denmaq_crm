...
<div class="container-fluid px-3 px-lg-4 py-4">
    <div class="page-heading">
        ...
        <div class="heading-actions"><button class="btn btn-outline-secondary btn-sm"
            type="button"><i class="bi bi-download" aria-hidden="true"></i>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <article class="metric-card metric-primary">
                <div class="metric-top">
                    ...
                    <span class="metric-icon"><i class="bi bi-person-lines-fill"
                        aria-hidden="true"></i></span>
                    </div>
                    <div class="metric-value">{{ number_format($leadsCount) }}</div>
                    <div class="metric-meta">
                        <span class="text-success">+{{ $leadsGrowth }}%</span>
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <article class="metric-card metric-success">
                    <div class="metric-top">
                        ...
                        <div class="metric-value">{{ number_format($clientsCount) }}</div>
                        <div class="metric-meta">
                            <span class="text-success">+{{ $clientsGrowth }}%</span>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <article class="metric-card metric-warning">
                        ...
                        <div class="metric-value">{{ number_format($projectsCount) }}</div>
                        <div class="metric-meta">
                            <span class="text-success">{{ $activeProjectsCount }}</span>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <article class="metric-card metric-danger">
                        <div class="metric-top">
                            ...
                            <span class="metric-icon"><i class="bi bi-file-earmark-text"
                                aria-hidden="true"></i></span>
                            </div>
                            <div class="metric-value">{{ number_format($quotationsCount) }}</div>
                            <div class="metric-meta">
                                <span class="text-danger">{{ $pendingQuotationsCount }}</span>
                                <span>pending</span>
                            </div>
                        </article>
                    </div>
